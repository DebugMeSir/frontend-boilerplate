...
- Viết code vào thư mục: project/source
  ...
  - riêng tailwind thì viết config vào project/source/ejs/parts/header.ejs vì dùng cdn tailwind script, nên phải link cdn và script phụ thêm cho tailwind vào <head>
